...
import com.example.android.todolist.data.DBHelper;
...
public class MainActivity extends AppCompatActivity implements AddToDoFragment.OnDialogCloseListener, UpdateToDoFragment.OnUpdateDialogCloseListener{
    ...
    protected void onStart() {
        ...
        adapter = new ToDoListAdapter(cursor, new ToDoListAdapter.ItemClickListener() {
            ...
            @Override
            public void onItemClick(int pos, String description, String duedate, long id, String category, String done) {
    ...
    @Override
    public void closeDialog(int year, int month, int day, String description, int id, String category, String done) {
    ...
    private Cursor getCategoryItems(SQLiteDatabase db) {
        String all[] = new String[]{
                ...
                Contract.TABLE_TODO.COLUMN_NAME_DONE,
        };
    ...
    private long addToDo(SQLiteDatabase db, String description, String duedate, String category, String done) {
    ...
    private int updateToDo(SQLiteDatabase db, int year, int month, int day, String description, long id, String category, String done){
    ...
    @Override
    public void closeUpdateDialog(int year, int month, int day, String description, long id, String category, String done) {
